...
class GenAI:
    def __init__(self,sub_index_key=0,alpha_index_key=0):
        ...
        self.alpha_prompt=open("./genai_v2/prompt/alpha_prompt.txt", "r", encoding="utf-8").read()
        self.alpha_system=open("./genai_v2/prompt/alpha_system.txt", "r", encoding="utf-8").read()
            ...
            try:
                ...
                for j in range(len(df_sub_hypothesis)):
                    ...
                    if expression_alpha!= 'invalid':
                        ...
                        #sharpe tồn tại và dương thì lưu còn âm thì đảo chiều giả thuyết
                        ...
                        self.append_rows(results) #chuyển lên gg sheet
                    else:
                        results=[[self.date, self.process_name, file_name] +auto_alpha.values.tolist()[0]]
...
if __name__ == '__main__':
    ...
    while True:
        try:
            GenAI(sub_index_key,alpha_index_key).run(file_pdf_path,type_category,number_drop)
        except Exception as e:
